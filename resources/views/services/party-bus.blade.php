                ...
                <div class="col-12 col-lg-8 order-1 order-lg-2">
                    <div class="ve-service-detail-content">
                        ...
                        <div class="ve-detail-text wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <p>When you're rolling with a large crew and want the celebration to never stop, an Elite Limo Party Bus is the only way to travel. Forget squeezing into tight sedans or splitting up into multiple rideshares. Our party buses let you stand up, walk around, and dance while en route to your destination.</p>
                            ...
                            <div class="ve-amenities-list mt-30 wow fadeInUp" data-wow-delay="300ms">
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul>
                                            <li><i class="fa fa-check"></i> Flat Screen TVs & Media Ports</li>
                            ...
                            <div class="ve-detail-extra-content mt-50">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 mb-30 wow fadeInRight" data-wow-delay="200ms">
                                        <h3>Safe & Reliable <span>Designated Driving</span></h3>
