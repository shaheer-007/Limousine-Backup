                ...
                <div class="col-12 col-lg-8 order-1 order-lg-2">
                    <div class="ve-service-detail-content">
                        ...
                        <div class="ve-detail-text wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <p>Nothing beats the excitement of live sports, but navigating stadium traffic, paying exorbitant parking fees, and appointing a designated driver can quickly drain the fun out of game day. Alar Chauffeur Service takes the hassle out of sporting events, allowing you and your group to focus purely on the action.</p>
                            ...
                            <div class="ve-amenities-list mt-30 wow fadeInUp" data-wow-delay="300ms">
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul>
                                            <li><i class="fa fa-check"></i> VIP Curbside Drop off and Pickup</li>
                                            <li><i class="fa fa-check"></i> High End Audio and Video Systems</li>
                            ...
                            <div class="ve-detail-extra-content mt-50">
                                ...
                                <div class="mt-40 wow fadeInUp" data-wow-delay="100ms">
                                    ...
                                    <div class="ve-quote-box mt-30">
                                        ...
                                        <p>Booking Alar Chauffeur Service for the championship game was the best decision we made. We avoided all the parking nightmares and had an amazing time tailgating in the Sprinter van. Highly recommended!</p>
                                ...
                                <div class="row align-items-center mt-50 mb-30">
                                    <div class="col-md-6 order-2 order-md-1 wow fadeInLeft" data-wow-delay="100ms">
                                        ...
                                        <p>No matter if your team wins or loses, you're guaranteed to finish the day like a champion with Alar Chauffeur Service.</p>
                                    </div>
