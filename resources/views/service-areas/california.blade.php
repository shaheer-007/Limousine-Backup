                    ...
                    <div class="ve-service-sidebar">
                        <div class="ve-sidebar-widget">
                            ...
                            <ul class="ve-sidebar-links">
                                ...
                                <li class="active"><a href="{{ route('service-area.california') }}">California</a></li>
                        ...
                        <div class="ve-sidebar-cta" style="background: var(--ve-dark); padding: 30px; border-radius: 12px; color: #fff;">
                            ...
                            <p style="font-size: 14px; opacity: 0.8; margin-bottom: 20px;">Experience premium transportation across California. Book your executive chauffeur online today.</p>
