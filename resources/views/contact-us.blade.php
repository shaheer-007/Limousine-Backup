                    ...
                    <div class="ve-contact-aside">
                        <div class="ve-ca-box">
                            ...
                            <ul class="ve-ca-list">
                                ...
                                <li><i class="fa fa-check-circle"></i> 24/7 Dispatch & Support</li>
        ...
        <div class="container">
            ...
            <div class="ve-coverage-grid">
                <div class="ve-coverage-item wow fadeInUp" data-wow-delay="100ms">
                    <h5>Florida</h5>
                    <ul>
                        <li><i class="fa fa-map-marker"></i> Orlando</li>
                        <li><i class="fa fa-map-marker"></i> Miami</li>
                        <li><i class="fa fa-map-marker"></i> Tampa</li>
                        <li><i class="fa fa-map-marker"></i> Jacksonville</li>
                    </ul>
                </div>
                <div class="ve-coverage-item wow fadeInUp" data-wow-delay="200ms">
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-map-marker"></i> Newark</li>
                        <li><i class="fa fa-map-marker"></i> Philadelphia</li>
                        <li><i class="fa fa-map-marker"></i> Boston</li>
                    </ul>
                </div>
                <div class="ve-coverage-item wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-map-marker"></i> Houston</li>
